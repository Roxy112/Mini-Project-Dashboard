...
export type StorageHash =
  StorageHashBase<'869257cfe1ab85db2bb6408edaaa175dcf233bd5bea3d15603afd2208c4a0fee'>;
        ...
        readonly entries: {
          readonly table: {
            readonly projects: {
              ...
              primaryKey: { readonly columns: readonly ['id']; readonly name: 'projects_pkey' };
              uniques: readonly [];
              indexes: readonly [];
            ...
            readonly tasks: {
              ...
              primaryKey: { readonly columns: readonly ['id']; readonly name: 'tasks_pkey' };
              uniques: readonly [];
              indexes: readonly [
                {
                  readonly name: 'idx_tasks_project_id';
              ...
              foreignKeys: readonly [
                {
                  ...
                  readonly name: 'tasks_project_id_fkey';
                },
              ];
            };
          };
